	...
	return (
		<footer className="footer">
			<Container>
				<div className="flex justify-between flex-col sm:flex-row pt-8">
					<div className="w-full sm:w-1/4">
						<a className="f-contact-container f-animation">
							...
							<span className="f-contact-text">Contacto</span>
						</a>
					...
					<div className="w-full flex justify-center items-center sm:justify-end sm:w-1/4">
						...
						<a className="text-white cursor-pointer f-animation">
				...
				<div className="flex flex-col py-4 md:justify-between md:flex-row">	
					<div className="flex flex-wrap justify-center md:justify-start">
						<a className="text-brown text-base mr-4 cursor-pointer f-animation">TyC</a>
						<a className="text-brown text-base mr-4 cursor-pointer f-animation">Políticas de Privacidad</a>
						<a className="text-brown text-base mr-4 cursor-pointer f-animation">Código de Conducta</a>
						<a className="text-brown text-base mr-4 cursor-pointer f-animation">Eventos</a>
						<a className="text-brown text-base cursor-pointer f-animation">Métricas</a>

					</div>
					<p className="text-gray-600 text-base text-center md:text-right">© Tigrenator, All Rights Reserved. LLC 2017</p>
				</div>
			</Container>
